...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = -150, maxDamage = -250, effect = CONST_ME_DRAWBLOOD },
	{ name = "singledeathchain", interval = 6000, chance = 15, minDamage = -350, maxDamage = -530, range = 5, effect = CONST_ME_MORTAREA, target = true },
	{ name = "singleicechain", interval = 6000, chance = 18, minDamage = -250, maxDamage = -450, range = 5, effect = CONST_ME_ICEATTACK, target = true },
