...
monster.attacks = {
	...
	{ name = "werelion wave", interval = 2000, chance = 20, minDamage = -250, maxDamage = -400, target = false },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_HOLYDAMAGE, minDamage = -400, maxDamage = -610, range = 3, effect = CONST_ME_HOLYAREA, target = true },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_HOLYDAMAGE, minDamage = -270, maxDamage = -350, range = 3, shootEffect = CONST_ANI_HOLY, target = true },
}
